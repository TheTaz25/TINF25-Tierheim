...
const animalBuilder = () => {
  ...
  function setHealth (value, asDelta = true) {
    if (asDelta) {
  ...
  function setEnergy (value, asDelta = true) {
    if (asDelta) {
  ...
  function setHunger (value, asDelta = true) {
    if (asDelta) {
  ...
  function setTrust (value, asDelta = true) {
    if (asDelta) {
